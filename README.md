...
files, you watch them render live, you drop comments on the canvas, and it
addresses them.
...
- **Commentable** — toggle 💬 **Comment**, drop pins on the diagram, then
  **Send to Claude** to have it address them and mark each resolved.
